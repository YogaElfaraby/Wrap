        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600; color: #0A76D8;">Appointment Manager</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px; color: #0A76D8;">My Appointments (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <thead>
                        <tr>
                                <th class="table-headin" style="color: #0A76D8;">
                                    Patient name
                                </th>
                                <th class="table-headin" style="color: #0A76D8;">
