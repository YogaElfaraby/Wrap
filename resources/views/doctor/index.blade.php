        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <p style="font-size: 23px;padding-left:12px;font-weight: 600;margin-left:20px; color: #0A76D8;">     Dashboard</p>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Thank you for joining us. We strive to provide you with comprehensive service. <br>
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px; color: #0A76D8;">Status</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                                        <div>
                                                                ...
                                                                <div class="h3-dashboard" style="color: white">
                                                                    All Doctors &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                </div>
                                                        </div>
                                ...
                                <td>
                                    ...
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;color: #0A76D8;">Your Up Coming Sessions until Next week</p>
                                    <center>
                                        ...
                                        <tr>
                                                <th class="table-headin" style="color: white">
